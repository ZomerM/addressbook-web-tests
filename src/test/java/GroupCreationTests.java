...
public class GroupCreationTests {
    ...
    public void GroupCreationTests() {
        ...
        if (!wd.findElement(By.xpath("//form[@id='right']//select[normalize-space(.)='[all] [none] test1']//option[1]")).isSelected()) {
            wd.findElement(By.xpath("//form[@id='right']//select[normalize-space(.)='[all] [none] test1']//option[1]")).click();
        }
